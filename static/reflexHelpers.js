...
function squareRed() {
    ...
    squareElement.innerHTML = '<h1><i class="fa-solid fa-ellipsis"></i></h1><p>Wait for Green</p>';
...
function squareGreen() {
    ...
    squareElement.innerHTML = '<p>Click now!</p>';
...
function toEarly() {
    const squareElement = document.querySelector('.square');
    squareElement.innerHTML = '<p>Too early, try again!</p>';
    squareElement.style.backgroundColor = 'rgb(96, 96, 255)';
}
...
function showResult() {
    ...
    <h1>~${averageTime / attempts}ms</h1><br>
